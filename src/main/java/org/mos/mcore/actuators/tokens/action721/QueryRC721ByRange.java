...
@Slf4j
@Data
public class QueryRC721ByRange extends SessionModules<ReqQueryRC721TokenByRange> {
	...
	public String[] getCmds() {
		return new String[] { Action721CMD.QCR.name() };
	}
	...
	@Override
	public void onPBPacket(final FramePacket pack, final ReqQueryRC721TokenByRange pb, final CompleteHandler handler) {
